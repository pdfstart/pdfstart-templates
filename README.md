...
| --- | --- | --- |
| Make my notes a report I can send to my boss | `@pdfstart/report-templates` | `npx @pdfstart/report-templates your-notes.md` |
...
- `packages/report-templates` - `@pdfstart/report-templates`, the report scenario
...
```bash
pnpm install
pnpm run build        # bundle @pdfstart/report-templates CLI
